...
function PriceHero() {
    ...
    return (
        <>
            <div ref={ref} className="flex items-center justify-center  bg-yellow-400 p-10 rounded-b-3xl flex-col">
                <div className="flex flex-row items-center flex-wrap justify-center">
                    <div className="flex items-center justify-center lg:flex-row items-center flex-col">
                        <div className="flex flex-col p-10 items-center gap-5">
                            <div className="flex items-end justify-center flex-row items-center ">
                                <span className="text-sm text-lg">от</span><p className="sm:text-9xl text-6xl font-bold"> {inView && (<CountUp duration={2} end={999} />)}</p><span className="text-sm text-lg">грн</span>
                            </div>
                    ...
                    <div ref={ref} className="flex items-center justify-center lg:flex-row items-center flex-col">
                        <div className="flex flex-col p-10 items-center gap-5">
                            <div className="flex items-end justify-center flex-row items-center ">
                                <span className="text-sm text-lg">от</span><p className="sm:text-9xl text-6xl font-bold"> {inView && (<CountUp duration={3} end={50} />)}</p> <span className="text-sm text-lg">грн/км</span>
                            </div>
                            <div className="flex items-center justify-center flex-row items-center ">
                    ...
                    <div ref={ref} className="flex items-center justify-center lg:flex-row items-center flex-col">
                        <div className="flex flex-col p-10 items-center gap-5">
                            <div className="flex items-end justify-center flex-row items-center ">
                                <span className="text-sm text-lg">от</span><p className="sm:text-9xl text-6xl font-bold">{inView && (<CountUp duration={4} end={700} />)}</p> <span className="text-sm text-lg">грн</span>
                            </div>
                            <div className="flex items-center justify-center flex-row items-center ">
