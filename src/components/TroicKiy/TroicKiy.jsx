import troickiy from '../../assets/image/Troickiy.svg';
            ...
            >
                ...
                <div className="absolute inset-0 flex flex-col md:flex-row  gap-10 px-6 md:px-20 ">
                    ...
                    <div className="flex flex-col text-white max-w-[550px] px-2 items-center justify-center p-10">
                        ...
                        >
                            Вызов эвакуатора <br />{" "}<span className="text-yellow-400 text-5xl">Троицкое</span><br /><span className="text-yellow-400 text-2xl ">круглосуточно 24/7</span>
                        </motion.h1>
                        ...
                        >
                            <span className="text-white  font-light text-4xl">Эвакуация всех видов транспорта в Троицком, Одесская область трасса E-95</span>
                        </motion.h2>
